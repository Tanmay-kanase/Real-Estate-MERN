        ...
        <>
            {landlord && (
                <div className='flex flex-col gap-2'>
                    ...
                    <Link to={`mailto:${landlord.email} ? subject=Regarding ${landlord.name}&body=${message}`} className='bg-slate-700 text-white text-center p-3 rounded-lg uppercase hover:opacity-95 '>
                     Send Message
                    </Link>
                </div>
            )
